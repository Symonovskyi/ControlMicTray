...
from logic.controllers.interfaces.ipolicyconfig import (
    IPolicyConfig,
...
class MicrophoneController(AudioUtilities):
    ...
    def __init__(self):
        ...
        self.__active_mic = cast(
            self.__default_mic.Activate(IAudioEndpointVolume._iid_, CLSCTX_ALL, None),
